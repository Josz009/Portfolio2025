      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Enterprise <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Cybersecurity</span> Excellence
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              {securityMetrics.map((metric, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-indigo-600 font-mono text-lg font-bold">
                      {metric.value}
                    </div>
                  </div>
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 rounded-full">
              ...
              <span className="text-indigo-600 font-semibold">Cybersecurity Professional</span>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {securityTechnologies.map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-indigo-50 hover:text-indigo-600 transition-colors"
                  >
                    {tech}
                  </span>
                ))}
            ...
            <div className="flex gap-4 pt-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all flex items-center gap-2"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 bg-white border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:border-indigo-500 hover:text-indigo-600 transition-all flex items-center gap-2"
              >
